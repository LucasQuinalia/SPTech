...
/*
"O histórico mostra as páginas que você visitou no Chrome nos últimos 90 dias. Ele não armazena páginas do Chrome (como chrome://settings), páginas visitadas no modo de navegação anônima nem aquelas que já foram excluídas do seu histórico de navegação."
*/
...
INSERT INTO historico (titulo, url, dataHora) VALUES ('Fazer login no Canvas (instructure.com)', 'https://awsacademy.instructure.com/login/canvas', '2023-02-16 10:36:00');
...
INSERT INTO historico (nome, url, navegador) VALUES ('404 Not Found', 'http://moodletech.azurewebsites.net/', 'Google Chrome');
