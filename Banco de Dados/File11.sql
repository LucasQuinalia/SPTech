...
select * from FashionStore where tamanho not like 'M';
...
select * from FashionStore where categoria like '%Camiseta%' or categoria like '%Blusa%';
...
select * from FashionStore where categoria like '%Calça%' and preco > 100;
...
select concat(nome, ', ', categoria, ', R$', preco) as info_completa from FashionStore;

-- Mostre os produtos que estão disponíveis e têm tamanho 'M'.
select * from FashionStore where tamanho = 'M' and disponivel = 1;
...
insert into FashionStore (nome, categoria, preco, tamanho, data_cadastro, disponivel) values ('Jaqueta Couro', 'Blusas', 167, 'M', '2025-01-19 00:00:00', 1);
...
insert into FashionStore (nome, categoria, preco, tamanho, data_cadastro, disponivel) values ('Short Verde', 'Bermudas', 367, 'M', '2025-01-19 00:00:00', 1);
...
update FashionStore set disponivel = 1 where data_cadastro > '2025-08-29';
...
insert into FashionStore (nome, categoria, preco, tamanho, data_cadastro, disponivel) values 
	('Calça cargo', 'Calça', 19.99, 'G', '2025-08-25 00:00:00', 1)
;
...
select * from FashionStore where categoria not in ('Camiseta', 'Calça', 'Short');
...
select nome as 'nome_produto', preco as 'preco_atual', data_cadastro, concat(nome, ', ', categoria, ', R$', preco) as descricao,
	case
